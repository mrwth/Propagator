...
For a general $V_+$ the conformal invariance of the $V_+$-boundary condition gets broken by perturbative quantization, and we should get a RG flow of the boundary condition, i.e.\ of the subspace $V_+\subset\g$. It should give us the RG flow (i.e.\ the Ricci flow) of the 2-dim $\sigma$-models; indeed, the RG flow should only affect $V_+$, and not the bulk CS theory or its topological boundary conditions.
...
\end{equation}
Given any 2 points 
$$q_1\neq q_2\in B^3$$ let $\gamma$ be the hyperbolic geodesics passing through $q_1$ and $q_2$, where we view $B^3$ as the Poincaré model of the hyperbolic space. Let 
$$z_1,z_2\in\CP=S^2$$
